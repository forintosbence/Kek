...
public class KedvencekActivity extends AppCompatActivity {
    ...
    private void kiir() {
        ...
        String text = "<html><body><style>body{line-height:"+sortav+"em; font-size:"+alapBetuMeret+"em;color:"+Statikus.szovegSzin+";} h1,h2,h3,h4,h5,h6,h7{margin: 0; padding: 0; border: 0; font-size: 100%; font: inherit;vertical-align: baseline;} h3{padding: 10px 0px;font-size: 1.2em; font-weight: bold; text-align:center;} p{ white-space: nowrap; margin: 0px; margin-top: 3px; height: 1.25em; overflow: hidden; /*margin-right: 40px;*/ } a{color:"+Statikus.szovegSzin+"; text-decoration:none; padding: 15px 0px; display: block; border-bottom: 1px solid #ababab;} .kiemel{color:red;}</style>" + html + "</body></html>";
